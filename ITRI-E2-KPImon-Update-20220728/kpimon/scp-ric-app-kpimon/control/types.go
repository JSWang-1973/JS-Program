...
type Timestamp struct {
	TVsec  int64 `json:"tv-sec"`
	TVnsec int64 `json:"tv-nsec"`
}
...
type CellMetricsEntry struct {
	...
	RANName                string    `json:"RAN-Name"`
}

// updated by sww, ITRI - fix data type converting problem
type BWPType struct {
	BWPID   uint16 `json:"BWP-ID"`
	LocationAndBandwidth uint16 `json:"Location-And-Bandwidth"`
}

type CellRFType struct {
	RSRP   int32 `json:"rsrp"`
	RSRQ   int32 `json:"rsrq"`
	RSSINR int32 `json:"rsSinr"`
}
